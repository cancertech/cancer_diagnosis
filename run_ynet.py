# author          : Sachin Mehta, Beibin Li
from utils.segmentation_features import get_seg_features, get_rgb_features
...
def process(imagename, img_arr=None, batch_size=10, model=None, 
    ...
    output_csv_name = os.path.join(output_dir, output_prefix + ".csv")
    ...
    # %%
    fstream = open(output_csv_name, "w")
...
if __name__ == "__main__":
    ...
    process(filename, img_arr=None, batch_size=16, model=None, output_dir="out2", output_prefix="1883_1")
